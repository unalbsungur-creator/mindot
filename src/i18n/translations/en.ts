...
export const en: Dictionary = {
  ...
  pointsMilestone: {
    heading: "Goal: 1 Million Dots",
    body: "Every thought leaves a dot on the wall.",
  ...
  memory: {
    ...
    pdfTokenBalance: "Token balance: {count}",
    pdfReady: "Your PDF is unlocked — download it as often as you like.",
    pdfUnlockButton: "Unlock PDF with 1 Token",
    pdfUnlockRequired: "Unlocking this PDF takes 1 Token.",
    pdfUnlockConfirmTitle: "Unlock this PDF?",
    pdfUnlockConfirmBody: "This uses 1 Token, once. After that, you can download this PDF again anytime without spending another Token.",
    pdfUnlockConfirmButton: "Use 1 Token",
    pdfUnlockCancel: "Cancel",
  ...
  archive: {
    ...
    toLabel: "To",
    applyRange: "Apply",
    searchPlaceholder: "Search my archive...",
    searchButton: "Search",
    clearSearchAction: "Clear search",
    searchActiveLabel: "Searching my archive for: {query}",
    emptyMessage: "Nothing here yet for this period.",
    emptyMessageAllTime: "You haven't written anything yet.",
    emptyMessageSearch: "No thought matches this search.",
