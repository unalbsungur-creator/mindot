...
export const es: Dictionary = {
  ...
  pointsMilestone: {
    heading: "Objetivo: 1 millón de puntos",
  ...
  memory: {
    ...
    pdfTokenBalance: "Saldo de Tokens: {count}",
    pdfReady: "Tu PDF está desbloqueado: descárgalo tantas veces como quieras.",
    pdfUnlockButton: "Desbloquear PDF con 1 Token",
    pdfUnlockRequired: "Desbloquear este PDF requiere 1 Token.",
    pdfUnlockConfirmTitle: "¿Desbloquear este PDF?",
    pdfUnlockConfirmBody: "Esto usa 1 Token, una sola vez. Después podrás volver a descargar este PDF cuando quieras sin gastar otro Token.",
    pdfUnlockConfirmButton: "Usar 1 Token",
    pdfUnlockCancel: "Cancelar",
