...
export const de: Dictionary = {
  ...
  memory: {
    ...
    pdfTokenBalance: "Token-Guthaben: {count}",
    pdfReady: "Dein PDF ist freigeschaltet — lade es so oft herunter, wie du möchtest.",
    pdfUnlockButton: "PDF mit 1 Token freischalten",
    pdfUnlockRequired: "Zum Freischalten dieses PDFs brauchst du 1 Token.",
    pdfUnlockConfirmTitle: "Dieses PDF freischalten?",
    pdfUnlockConfirmBody: "Dafür wird einmalig 1 Token verwendet. Danach kannst du dieses PDF jederzeit erneut herunterladen, ohne einen weiteren Token auszugeben.",
    pdfUnlockConfirmButton: "1 Token verwenden",
    pdfUnlockCancel: "Abbrechen",
