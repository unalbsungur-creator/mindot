...
export const tr: Dictionary = {
  ...
  memory: {
    ...
    pdfTokenBalance: "Token bakiyen: {count}",
    pdfReady: "PDF'in açık — istediğin kadar indirebilirsin.",
    pdfUnlockButton: "PDF'i 1 Token ile aç",
    pdfUnlockRequired: "Bu PDF'i açmak için 1 Token gerekiyor.",
    pdfUnlockConfirmTitle: "Bu PDF açılsın mı?",
    pdfUnlockConfirmBody: "Bu işlem bir defaya mahsus 1 Token kullanır. Sonrasında bu PDF'i istediğin zaman yeniden Token harcamadan indirebilirsin.",
    pdfUnlockConfirmButton: "1 Token kullan",
    pdfUnlockCancel: "Vazgeç",
