...
/**
 * Always renders `WriteThoughtForm` once the invitation itself is valid,
 * whether or not `sessionUser` is set — a signed-out invitee can compose
 * their thought first and only reaches Google sign-in (gated by the
 * mandatory consent checkbox) once they try to continue. This used to be
 * two separate branches (a bare sign-in screen vs. the form), which is
  ...
  return (
    <PageContainer className="py-16">
      <div className="mx-auto flex max-w-3xl flex-col items-center gap-3 pb-8 text-center">
        ...
        <h1 className="font-display text-2xl font-medium text-navy sm:text-3xl">{dictionary.invite.heading}</h1>
